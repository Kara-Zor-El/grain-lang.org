...
If you'd prefer not to use homebrew, you can [download it](https://github.com/grain-lang/grain/releases/download/grain-v0.7.2/grain-mac-x64) directly from GitHub or using `curl`.
...
You can [download it](https://github.com/grain-lang/grain/releases/download/grain-v0.7.2/grain-linux-x64) directly from GitHub or using `curl`.
...
You can [download it](https://github.com/grain-lang/grain/releases/download/grain-v0.7.2/grain-win-x64.exe) directly from GitHub or using `curl`.

```batch
curl -LO https://github.com/grain-lang/grain/releases/download/grain-v0.7.2/grain-win-x64.exe
```
